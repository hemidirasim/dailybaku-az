...
## ⚠️ Vacib: Vercel-də Deploy Command-i Silin

Əgər hələ də Vercel istifadə edirsinizsə və build xətası alırsınızsa:

1. Vercel Dashboard → Project Settings → General
2. "Build & Development Settings" bölməsində **"Deploy Command"**-i tapın
3. `npx wrangler deploy` command-ini **silin** (boş buraxın)
4. Dəyişiklikləri saxlayın

**Qeyd:** Next.js layihələri üçün Vercel avtomatik olaraq build və deploy edir. Əlavə deploy command lazım deyil.
...
**Qeyd:** Cloudflare Pages Next.js üçün avtomatik olaraq `.next` output directory-ni tanıyır.
...
- [Next.js on Cloudflare Pages](https://developers.cloudflare.com/pages/framework-guide/nextjs/)
